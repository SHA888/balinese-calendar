...
impl Wuku {
    ...
    pub fn from_index(idx: usize) -> Self {
        match idx % 30 {
            0  => Wuku::Sinta,        1  => Wuku::Landep,
            2  => Wuku::Ukir,         3  => Wuku::Kulantir,
            4  => Wuku::Tolu,         5  => Wuku::Gumbreg,
            6  => Wuku::Wariga,       7  => Wuku::Warigadean,
            8  => Wuku::Julungwangi,  9  => Wuku::Sungsang,
            10 => Wuku::Dungulan,     11 => Wuku::Kuningan,
            12 => Wuku::Langkir,      13 => Wuku::Medangsia,
            14 => Wuku::Pujut,        15 => Wuku::Pahang,
            16 => Wuku::Krulut,       17 => Wuku::Merakih,
            18 => Wuku::Tambir,       19 => Wuku::Medangkungan,
            20 => Wuku::Matal,        21 => Wuku::Uye,
            22 => Wuku::Menail,       23 => Wuku::Prangbakat,
            24 => Wuku::Bala,         25 => Wuku::Ugu,
            26 => Wuku::Wayang,       27 => Wuku::Kelawu,
            28 => Wuku::Dukut,        _  => Wuku::Watugunung,
        }
    }
    ...
    pub fn start_day(&self) -> u16 { (self.index() as u16) * 7 }

    pub fn name(&self) -> &'static str {
        match self {
            Wuku::Sinta        => "Sinta",       Wuku::Landep       => "Landep",
            Wuku::Ukir         => "Ukir",         Wuku::Kulantir     => "Kulantir",
            Wuku::Tolu         => "Tolu",         Wuku::Gumbreg      => "Gumbreg",
            Wuku::Wariga       => "Wariga",       Wuku::Warigadean   => "Warigadean",
            Wuku::Julungwangi  => "Julungwangi",  Wuku::Sungsang     => "Sungsang",
            Wuku::Dungulan     => "Dungulan",     Wuku::Kuningan     => "Kuningan",
            Wuku::Langkir      => "Langkir",      Wuku::Medangsia    => "Medangsia",
            Wuku::Pujut        => "Pujut",        Wuku::Pahang       => "Pahang",
            Wuku::Krulut       => "Krulut",       Wuku::Merakih      => "Merakih",
            Wuku::Tambir       => "Tambir",       Wuku::Medangkungan => "Medangkungan",
            Wuku::Matal        => "Matal",        Wuku::Uye          => "Uye",
            Wuku::Menail       => "Menail",       Wuku::Prangbakat   => "Prangbakat",
            Wuku::Bala         => "Bala",         Wuku::Ugu          => "Ugu",
            Wuku::Wayang       => "Wayang",       Wuku::Kelawu       => "Kelawu",
            Wuku::Dukut        => "Dukut",        Wuku::Watugunung   => "Watugunung",
        }
    }
