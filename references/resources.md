# Balinese Calendar & Wariga — Research Resources Download Checklist

> Compiled from validated online sources. Each item is atomic: one source, one URL where possible, with a note on what it contains and why it matters.

## Status Legend

- `[ ]` — not yet downloaded
- `[~]` — partially accessed / online-only
- `[x]` — downloaded / archived locally
- `⚠` — access caveat (institutional, paywall, or unverified copy)
...
- [ ] **Lontar Sundarigama** — search Internet Archive, BasaBali, PDK Bali
  - Canonical source for rerahinan characterization
- [ ] **Lontar Wariga Uliken** — cross-referenced in Wariga Gemet itself
- [ ] **Lontar Medangkemulan** — cited as source for wewaran day-names & deities
- [ ] **Lontar Bagawan Garga** — cited as source for wewaran qualities
- [ ] **Lontar Lelanusan** — cited in tatkala.co article for Lanus/Ayu-Ala rules
...
- [ ] **Dershowitz & Reingold, *Calendrical Calculations*, "The Balinese Pawukon Calendar" chapter** ⚠ — `https://www.cambridge.org/core/books/calendrical-calculations/balinese-pawukon-calendar/AE3E7D55A609FFA3017A40C70A15A758`
  - Cambridge University Press; paywalled; formal algorithmic treatment
- [ ] **Ethnomathematics of Balinese Calendar (JoMEaL, Jember)** — `https://journal.unej.ac.id/JoMEaL/article/view/1913`
  - Explicitly identifies 210 = LCM(5,6,7) as structural foundation
- [ ] **Multi Parameter Design in AIML Framework for Balinese Calendar (Gale OneFile)** — `https://go.gale.com/ps/i.do?p=AONE&u=googlescholar&id=GALE%7CA616056168`
  - Contains full tabulation of all ten wewaran
- [ ] **Ramdhani, F. Z. (2017). "Analisis Sistem Penanggalan Pawukon Bali." UIN Walisongo thesis** ⚠
  - Search institutional repository: `http://eprints.walisongo.ac.id/`
- [ ] **Suarka, I. N. (2008). "Sistem Penanggalan Bali." Makalah Seminar Nasional Menelusuri Sistem Penanggalan Nusantara.** ⚠
  - Universitas Udayana seminar paper; check Unud repository
...
- [ ] **I Wayan Ardika — Laporan Ekskavasi Arkeologi di Desa Pacung, Sembiran dan Julah (1988)** ⚠
  - Referenced in Historia.id; check Unud/Arkenas archives
...
- [ ] **I Ketut Bangbang Gde Rawi — *Wariga Dewasa* / *Kalender Bali***
  - The standard almanac reference in Bali; available via Balinese bookstores
- [ ] **Arya Suryawan — *Ala-Ayu Padewasan Wariga Dewasa* (A5, 218 pp)** — `https://www.tokopedia.com/mbukubali/ala-ayu-padewasan-wariga-dewasa`
  - Includes wariga formulas, urip tables, rumus-rumus
- [ ] **Ida Pedanda Gede Buruan — *Padewasan Kapelek***
  - Primary source for the folio 11a citation of Alahing Sasih
- [ ] **Fred B. Eiseman — *Bali: Sekala and Niskala Vol. I*, calendar chapter**
  - Ethnographic; widely cross-referenced
- [ ] **Ian Proudfoot — *Old Muslim Calendars of Southeast Asia* (Brill, 2006)**
  - Comparative calendrical methodology
...
- [ ] **Gedong Kirtya (Singaraja) — lontar library** ⚠
  - Historical lontar collection; some digitized
...
- [ ] **Universitas Udayana institutional repository** — search SINTA & Unud eprints
  - Indonesian-language academic work on wariga computation
- [ ] **Google Scholar query: "pawukon" OR "wewaran" site:ac.id** ⚠
  - Surfaces `.ac.id` (Indonesian academic) sources

---

## Verification Notes

1. **Alahing Sasih folio citation.** The specific claim that the formula "*wewaran alah dening wuku…*" sits on folio 11a of Wariga Gemet traces to Ida Pedanda Gede Buruan's *Padewasan Kapelek* (via Tribun Bali). **This has not been independently verified against the digitized folios.** Verifying this requires reading the scanned manuscripts in Section 1 and cross-checking against related lontar in Section 3.

2. **Multiple manuscript recensions.** "Wariga Gemet" and "Wariga Gede Gemet" are likely different copies — possibly with textual variation. Treat single-manuscript claims as provisional until cross-validated.

3. **Tri Wara market-day claim.** The `rgas pasar` ↔ Tri Wara mapping is documented in the Historia.id article citing Bali Kuno epigraphy (Section 5). The specific "3-village rotating circuit" model is **not** directly attested and should be treated as hypothesis until confirmed via the Leiden KITLV or Indonesian academic sources.

4. **Licensing.** Wikimedia Commons files are PD Indonesia. Internet Archive lontar scans appear to be public domain by age. Scribd copies should be treated as unverified mirrors. Academic papers vary; the listed open-access links are confirmed accessible as of April 2026.

5. **Quality tier priority for research.** Primary lontar scans (§1) > peer-reviewed academic (§4) > historical documentation (§5) > practitioner interpretation (§8). Use practitioner sources for living practice context, not for historical claims.
